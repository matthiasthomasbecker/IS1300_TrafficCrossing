...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, LD2_Pin|SPI_CS_U2_Pin|Reset_595_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, SPI_CS_U1_Pin|SPI_CS_U3_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, Disp_DataInstr_Pin|Disp_Reset_Pin|Disp_CS_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LD2_Pin SPI_CS_U2_Pin Reset_595_Pin */
  GPIO_InitStruct.Pin = LD2_Pin|SPI_CS_U2_Pin|Reset_595_Pin;
  ...
  GPIO_InitStruct.Pin = SPI_CS_U1_Pin|SPI_CS_U3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  GPIO_InitStruct.Pin = Disp_DataInstr_Pin|Disp_Reset_Pin|Disp_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);
